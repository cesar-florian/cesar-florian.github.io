...
(() => {
            ...
            setSubHeadings(t) {
                ...
                for (const [e, i] of t) {
                    ...
                    s.classList.add("tree-hint-container"), t.itemEl.appendChild(s), i.forEach((t => {
                        ...
                        i.classList.add("tree-hint-label"), i.classList.add("internal-link"), i.textContent = t, i.href = e + "#" + t.replaceAll(' ', '_').replaceAll(':', '') + '_0', s.appendChild(i)
                    })), $.initializeLinks(s)
                }
            }
            removeSubHeadings() {
    ...
    window && window.location && (window.ObsidianSite = new class {
        ...
        getWebpageData(t) {
            ...
            if (this.metadata) {
                const e = this.metadata.webpages[t.split('#')[0]];
                if (e) return e
            }
        }
        getFileData(t) {
